...
export default function HeroSlider({ language, onExplore }: HeroSliderProps) {
  ...
  const slides = [
    {
      id: 'slide-watch',
      category: language === 'FR' ? 'HAUTE HORLOGERIE' : 'HIGH HOROLOGY',
      title: language === 'FR' ? 'Chronographe Kribi' : 'Kribi Chronograph',
      subtitle: language === 'FR' ? 'Or Impérial & Cadran Bleu Abyss' : 'Imperial Gold & Abyss Blue Dial',
      description: language === 'FR' ? 'Conçue à Yaoundé, régulée en Suisse, façonnée dans l’or le plus noble.' : 'Conceived in Yaounde, tuned in Switzerland, crafted in the finest gold.',
      ...
      specs: ['72H POWER RESERVE', 'CALIBER DLD-900', '18K GOLD'],
    },
    {
      id: 'slide-jewelry',
      category: language === 'FR' ? 'HAUTE JOAILLERIE' : 'FINE JEWELRY',
      title: language === 'FR' ? 'Émeraude du Dja' : 'Dja Forest Emerald',
      subtitle: language === 'FR' ? 'L’Émeraude verte équatoriale d’exception' : 'Exceptional Equatorial Green Emerald',
      description: language === 'FR' ? 'Un éclat de forêt pluvieuse sauvage capturé dans l’or blanc éthique.' : 'A shard of wild rainforest captured in ethical white gold.',
      ...
      specs: ['4.2 CARATS EMERALD', 'HAND-SET DIAMONDS', '18K WHITE GOLD'],
    },
    {
      id: 'slide-coffret',
      category: language === 'FR' ? 'COFFRETS ET CRÉATIONS PRIVÉES' : 'CHESTS & PRIVATE CREATIONS',
      title: language === 'FR' ? 'L’Écrin d’Ébène' : 'The Ebony Chest',
      subtitle: language === 'FR' ? 'Bois précieux gravé à la main à Foumban' : 'Hand-carved precious wood from Foumban',
      description: language === 'FR' ? 'Vos pièces d’exception protégées dans le raffinement de l’ébène massif.' : 'Your master creations protected in solid premium ebony wood.',
      ...
      specs: ['SOLID EBONY WOOD', 'HAND-GRAVED PATTERNS', 'SECURE LOCK'],
    },
  ];
